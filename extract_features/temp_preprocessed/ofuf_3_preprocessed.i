# 0 "/mnt/e/OneDrive/Desktop/result/extract_features/cfiles32/loop-industry-pattern/ofuf_3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mnt/e/OneDrive/Desktop/result/extract_features/cfiles32/loop-industry-pattern/ofuf_3.c"
 void abort(void);
 void __assert_fail(const char *, const char *, unsigned int, const char *) ;
void reach_error1() { __assert_fail("0", "ofuf_3.c", 3, "reach_error1"); }
 void abort(void);
...
void * Id_MCDC_79;
 ...
 int strcmp(char const* Id_MCDC_80, char const* Id_MCDC_81);
...
UINT32 Id_MCDC_97();
 void * malloc(size_t Id_MCDC_98);
void Id_MCDC_99();
void Id_MCDC_100();
 FILE* fopen(char const* Id_MCDC_101, char const* Id_MCDC_102);
int main();
