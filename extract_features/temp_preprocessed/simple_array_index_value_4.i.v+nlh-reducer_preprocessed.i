# 0 "/mnt/e/OneDrive/Desktop/result/extract_features/cfiles32/loop-crafted/simple_array_index_value_4.i.v+nlh-reducer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mnt/e/OneDrive/Desktop/result/extract_features/cfiles32/loop-crafted/simple_array_index_value_4.i.v+nlh-reducer.c"
int __return_main;
void abort(void);
 void __assert_fail(const char *, const char *, unsigned int, const char *) ;
void reach_error1() { __assert_fail("0", "simple_array_index_value_4.i.v+nlh-reducer.c", 4, "reach_error1"); }
void abort(void);
