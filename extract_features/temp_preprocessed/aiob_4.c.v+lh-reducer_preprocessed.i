# 0 "/mnt/e/OneDrive/Desktop/result/extract_features/cfiles32/loop-industry-pattern/aiob_4.c.v+lh-reducer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/mnt/e/OneDrive/Desktop/result/extract_features/cfiles32/loop-industry-pattern/aiob_4.c.v+lh-reducer.c"
int __return_main;
void abort(void);
 void __assert_fail(const char *, const char *, unsigned int, const char *) ;
void reach_error1() { __assert_fail("0", "aiob_4.c.v+lh-reducer.c", 4, "reach_error1"); }
